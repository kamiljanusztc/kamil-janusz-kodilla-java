...
class BookDirectoryTestSuite {
    ...
    class TestBooksInHandsOff {
        ...
        @Test
        void testListBooksInHandsOffEqual0() {
            // Given
            BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
            LibraryUser libraryUser =  new LibraryUser("John", "Doe", "01234567890");
        ...
        @Test
        void testListBooksInHandsOffEqual1() {
            // Given
            BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
            LibraryUser libraryUser =  new LibraryUser("John", "Doe", "01234567890");
        ...
        @Test
        void testListBooksInHandsOffEqual5() {
            // Given
            BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
            LibraryUser libraryUser =  new LibraryUser("John", "Doe", "01234567890");
